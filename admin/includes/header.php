...
<header id="header">
	<a href="../index.php"><img src="../images/logo.png" width="198" height="95" style="margin-top:10px;" Alt="Metro Manga" /></a>
	...
	<section id="inscrire">
		...
		<form method="post" action="">
			...
			<div id="checkbox">
				...
				<label class="labelcondition" for="condition">En cochant cette case, je m'engage à respecter les conditions d'utilisations de <i>Metro Manga</i></label>
			</div>
		...
		<article id="info_inscription">
			...
			<div>
				...
				<p id="info_mail" style="display:none;">Saisissez une adresse e-mail valide et accessible pour valider votre compte et recevoir des mails de la part de <i>Metro Manga</i>.</p>
				<p id="info_box" style="display:none;">Vous venez de cocher la case, ce qui signifie que vous vous engagez à avoir un comportement adéquat sur tout le site.<br/> En cas d'infraction, votre compte sera suspendu en conséquence.</p>
			</div>
		</article>
	</section>
	<script>
